...
export async function generateLeadReply(lead: {
  ...
  const system = `You write a follow-up email on behalf of the AiFax team (AI-powered fax-to-EHR automation for
...
- Never write in the first person as an individual (no "I"), write as "we"/"our team".
